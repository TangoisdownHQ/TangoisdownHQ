...
- ✅ Smart contract audits (Solidity, EVM chains)  
- ✅ Web3 dApp & blockchain vulnerability research  
- ✅ Tokenization protocols & secure blockchain design  
- ✅ Honeypot development to trap attackers  
- ✅ Cloud & infrastructure security reviews  
- ✅ Research on satellite, drone, and deep space system security

---

### 💡 Current Focus

- Building Web3 security tools and honeypots 
- Pentests
- Researching advanced blockchain exploits  
- Exploring drone, satellite & aerospace cybersecurity  
- Helping teams secure token economies & decentralized ecosystems

---

### 🔨 Tools & Tech
- 🔐 Ethereum, Solidity, Hardhat, Foundry  
- ☁️ AWS, Docker, Kubernetes, CI/CD security  
- 🕸️ Deception tech: honeytokens, honeypots, canary tokens  
- 🛰️ Aerospace systems & satellite network research
