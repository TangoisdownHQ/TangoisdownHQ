...
- 💥 Offensive Security Professional/Researcher
- 🔍 Pentester | Vulnerability Researcher | Web3 Security Auditor | OSINT
...
- Web3 security tooling & honeypots
- AI red teaming & LLM security
- Researching blockchain exploitation techniques
- Exploring aerospace & deep-space cyber defense & security 
- Securing decentralized ecosystems & token economies
...
- Kubernetes
- CI/CD Security
- AWS,GCP,AZURE,AlIBABA CLOUD TECH INFRA
---
### 🔐 Security & Web3
...
---
### 🛰️ Aerospace & Research

- Drone Security
- Satellite Network Research
- Aerospace Systems Security
- Deep Space Communications Security

---
# 🚀 Mission

Building secure autonomous systems for the decentralized future —
from cloud infrastructure and AI agents to blockchain ecosystems and aerospace networks.
🌍 → ☁️ → 🔗 → 🛰️ → 🌌
